...
declare global {
  interface Window {
    onPropChanged: (key: string) => void
    onIntPropChanged: (key: string) => void
  }
}

export default (container: HTMLElement, qview: QPaintView) => {
  // ----------------------------------------------------------
  ...
  function onPropChanged(key: string) {
  ...
  function onIntPropChanged(key: string) {
    let elem = document.getElementById(key) as HTMLSelectElement
    elem.blur()
  ...
  function onSelectionChanged() {
    ...
    if (selection !== null) {
      ...
      (document.getElementById("lineWidth") as HTMLSelectElement).value = style.lineWidth + '';
      (document.getElementById("lineColor") as HTMLSelectElement).value = style.lineColor;
      (document.getElementById("fillColor") as HTMLSelectElement).value = style.fillColor
    }
  }

  function installPropSelectors() {
    qview.onSelectionChanged = onSelectionChanged
    container.insertAdjacentHTML("afterend", `<br><div id="properties">
